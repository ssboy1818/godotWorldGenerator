...
[[nodiscard]] WorldGenerationSettings toCoreSettings(
    ...
    return {
        ...
        .landTypeConditions = {
            .snowTemperature = settings.landTypeSnowTemperature(),
            ...
            .lowlandElevation = settings.landTypeLowlandElevation(),
            .hillElevation = settings.landTypeHillElevation(),
            .mountainElevation = settings.landTypeMountainElevation(),
        },
